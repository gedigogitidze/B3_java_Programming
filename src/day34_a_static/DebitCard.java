...
public class DebitCard {
    ...
    //card number, the cardholder name, and the balance.
   ...
   //     this.cardNumber = cardNumber;
        ...
        //The card type must be either MasterCard or Visa to be valid card type. If it is not one of those two then do not store the type and print “invalid card type”.
            // ill have if condition for this below

    public DebitCard(long cardNumber, String holderName, int pin, String cardType, double balance) {
//        this.cardNumber = cardNumber;
//        this.holderName = holderName;
//        this.balance = balance;
       ...
       // this.pin = pin;
        if((pin+"").length()==4){
            ...
            System.out.println("Invalid Pin Length - Has to be 4 digits");
        }
    }
    /*
        Add the toString method that will print all of the cards information (Except the pin). If the card type does not have a value do not print that line.
